// http://www.javamexico.org/foros/java_standard_edition/juego_quot_gato_quot_hecho_en_java
    ...
    public void elegirPosicion(int posicion){
    	    ...
    	    switch(posicion){
    		  ...
    		  //Comprueba Si La Posicion Esta Disponible Valiendose Del Metodo "comprobarEspacio()"
    			case 10:comprobarEspacio(getPosicionArreglo(0,0),0,0);break;
    			case 11:comprobarEspacio(getPosicionArreglo(0,1),0,1);break;
    			case 12:comprobarEspacio(getPosicionArreglo(0,2),0,2);break;
    			case 21:comprobarEspacio(getPosicionArreglo(1,0),1,0);break;
    			case 22:comprobarEspacio(getPosicionArreglo(1,1),1,1);break;
    			case 23:comprobarEspacio(getPosicionArreglo(1,2),1,2);break;
    			case 31:comprobarEspacio(getPosicionArreglo(2,0),2,0);break;
    			case 32:comprobarEspacio(getPosicionArreglo(2,1),2,1);break;
    			case 33:comprobarEspacio(getPosicionArreglo(2,2),2,2);break;
    			default:
